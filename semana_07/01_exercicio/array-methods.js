...
// 4. Usando spread operators com array
const fruits = ["maça", "banana", "laranja"];
const moreFruits = ["uva", "kiwi"];
const allFruits = [...fruits, ...moreFruits];

// 5. Usando spread com objetos
const person = { name: "Maria", age: 24 };
const employee = { ...person, id: 1001, department: "Engeharia" }
...
console.log("Objeto combinado: ", employee);