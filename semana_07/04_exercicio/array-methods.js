...
// 4. Combinando some e filter para encotrar tarefas incompletas de alta prioridade
const incompleteHighPriorityTask = tasks.filter(
	task => !task.completed && task.priority === "alta"
);
console.log("\nTarefas incompletas de alta prioridade:", incompleteHighPriorityTask);
